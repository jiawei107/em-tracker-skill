...
def update_config_file(new_account: dict, config_path: str = 'config.py') -> bool:
...
def run_config_adder(config_path: str = 'config.py'):
    ...
    if session:
        update_config_file(new_account, config_path)
    else:
